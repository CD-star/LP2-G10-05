...
public:
    Automovil(const string& placa)
        : Vehiculo(placa, "Automovil") {}

    void Informacion() const override {
        cout << "Placa: " << placa
           << ", Tipo: " << tipoVehiculo; // Sin endl, para que la clase Parqueadero lo controle
    }
...
public:
    Moto(const string& placa)
        : Vehiculo(placa, "Moto") {}

    void Informacion() const override {
        cout << "Placa: " << placa
           << ", Tipo: " << tipoVehiculo; // Sin endl
    }
                        ...
                        try {
                            switch (opc_usuario_sub) {
                                ...
                                case 3: { // Ingresar mi Vehiculo
                                    ...
                                    // Se eliminan las solicitudes de marca, modelo, color, puertas y cilindrada
                                    ...
                                    if (tipoVehiculo == "Automovil") {
                                        nuevoVehiculo = make_shared<Automovil>(placa);
                                    } else { // Moto
                                        nuevoVehiculo = make_shared<Moto>(placa);
                                    }
